	...
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="dropdown">
                <button class="dropbtn">CUTTING STATION - 4</button>
                    <div class="dropdown-content">
                        <a href="index.php">NO ACTION</a>
                        <a href="cutting_station_one.php">CUTTING STATION - 1</a>
                        <a href="cutting_station_two.php">CUTTING STATION - 2</a>
                        <a href="cutting_station_three.php">CUTTING STATION - 3</a>
                        <a href="cutting_station_four.php"> CUTTING STATION - 4</a>                        
