	...
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="tbl-top">
                <button class="drop_btn">CUTTING <br/> STATION - 1</button>
                <form name="theform" method="POST" action="/cutting_station_two.php">
                <input type="hidden" name="action" value="2">
                <a href="javascript:document.theform.submit()">CUTTING STATION - 2</a>
                </form>
                <form name="theform1" method="POST" action="/cutting_station_two.php">
                <input type="hidden" name="action" value="3">
                <a href="javascript:document.theform1.submit()">CUTTING STATION - 3</a>
                </form>
                <button class="drop_btn">CUTTING <br/> STATION - 4</button>
                <button class="drop_btn">HOLD</button>
                <button class="drop_btn">SPOOLING</button>
                <button class="drop_btn">REJECT</button>
                </div>
                <div class="drop_down">
